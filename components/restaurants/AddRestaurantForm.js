...
export default function AddRestaurantForm({ toastRef, setLoading, navigation }) {
    ...
    const addRestaurant = async() => {
        ...
        if(!responseAddDocument.statusResponse){
            toastRef.current.show('Error al grabar el restaurante, por favor intentar mas tarde', 3000)
        }
    ...
    const validForm = () => {
        ...
        if(!locationRestaurant){
            ...
            toastRef.current.show('Debes de agregar almenos una imagen del restaurante', 3000)
            isValid = false    
        }
...
function UploadImage({ toastRef, imagesSelected, setImagesSelected }){
    const imageSelect = async() =>{
        ...
        if(!response.status){
            toastRef.current.show('No has seleccionad ninguna imagen', 3000)
            return
        }
        ...
        <View style={styles.viewForm}>
            ...
            <Input
                ...
                rightIcon={{
                    type:'material-community',
                    name:'google-maps',
                    color:locationRestaurant ? '#e33b04' :'#c2c2c2',
